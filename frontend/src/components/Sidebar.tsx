      ...
      <aside className={`flex w-64 flex-col border-r border-white/30 bg-white/30 text-slate-900 backdrop-blur-2xl shadow-[0_20px_60px_rgba(15,23,42,0.12)] transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="border-t border-white/20 p-4 space-y-2">
          <a
            ...
            className="flex items-center gap-2 w-full rounded-2xl px-4 py-2.5 text-sm text-slate-600 transition-all hover:bg-white/30 hover:text-slate-900"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-2xl px-4 py-2.5 text-sm text-slate-600 transition-all hover:bg-white/30 hover:text-slate-900"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
